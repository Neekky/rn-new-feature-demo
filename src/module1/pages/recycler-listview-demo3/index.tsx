...
export default class MainComponent extends Component {
  _parentRLVLayoutProvider: LayoutProvider;
  _childRLVLayoutProvider: LayoutProvider;
  _parentContextProvider: ContextHelper;
  _childArr: string[];
  constructor(props) {
    super(props);
      ...
      <View style={styles.container}>
        ...
        {this.state.isViewMounted ? (
          ...
          <Text style={styles.indicatorText}>
            Click on toggle to mount lists again
          </Text>
        )}
      </View>
    );
